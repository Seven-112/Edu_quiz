...
public class CommunityQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.transparentStatusAndNavigation(CommunityQuestionActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.askquestion:
                Utils.CheckVibrateOrSound(CommunityQuestionActivity.this);
                Intent playQuiz = new Intent(CommunityQuestionActivity.this, SettingActivity.class);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (!error) {
                               ...
                               Toast.makeText(CommunityQuestionActivity.this,"Question Added Succesfully",Toast.LENGTH_SHORT).show();
                                JSONArray jsonArray = jsonObject.getJSONArray(Constant.DATA);
                                Intent intent2 = new Intent(CommunityQuestionActivity.this, CommunityActivity.class);
                               ...
                               /* for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                Toast.makeText(CommunityQuestionActivity.this,"Something went wrong. Please try again.",Toast.LENGTH_SHORT).show();
                            }
                        ...
                        try {
                            ...
                            if (!error) {
                                ...
                                ArrayAdapter<Category> adapter =
                                        new ArrayAdapter<Category>(CommunityQuestionActivity.this,  android.R.layout.simple_dropdown_item_1line, categoryList);
                        ...
                        try {
                            ...
                            if (!error) {
                                ...
                                ArrayAdapter<SubCategory> adapter =
                                        new ArrayAdapter<SubCategory>(CommunityQuestionActivity.this,  android.R.layout.simple_spinner_dropdown_item, subcatList);
