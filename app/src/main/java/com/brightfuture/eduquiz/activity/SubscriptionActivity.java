...
import com.brightfuture.eduquiz.util.IabBroadcastReceiver;
import com.brightfuture.eduquiz.util.IabHelper;
import com.brightfuture.eduquiz.util.IabResult;
import com.brightfuture.eduquiz.util.Inventory;
import com.brightfuture.eduquiz.util.Purchase;
...
public class SubscriptionActivity  extends Activity implements IabBroadcastReceiver.IabBroadcastListener,
        DialogInterface.OnClickListener {

    ImageView iv;
    TextView tvsubscriptiondesc;
    ...
    static final String SKU_INFINITE_GAS_MONTHLY = "6month";
    static final String SKU_INFINITE_GAS_YEARLY = "1years";
    static final String SKU_INFINITE_GAS_QUATER = "90days";

    // (arbitrary) request code for the purchase flow
    static final int RC_REQUEST = 10001;

    // Graphics for the gas gauge
    static int[] TANK_RES_IDS = { R.drawable.achievement_bg, R.drawable.alarm, R.drawable.aud_progress_bg,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        iv=findViewById(R.id.free_or_premium);
        tvsubscriptiondesc=findViewById(R.id.tvsubscriptiondesc);
        // load game data
        loadData();
         ...
         */
        String base64EncodedPublicKey = "";
    ...
    IabHelper.QueryInventoryFinishedListener mGotInventoryListener = new IabHelper.QueryInventoryFinishedListener() {
        public void onQueryInventoryFinished(IabResult result, Inventory inventory) {
         ...
         /*   // Do we have the premium upgrade?
            ...
            Purchase gasQuaterly = inventory.getPurchase(SKU_INFINITE_GAS_QUATER);
            if (gasMonthly != null && gasMonthly.isAutoRenewing()) {
                ...
                mInfiniteGasSku = SKU_INFINITE_GAS_QUATER;
                mAutoRenewEnabled = true;
            } else {
                mInfiniteGasSku = "";
            ...
            mSubscribedToInfiniteGas = (gasMonthly != null && verifyDeveloperPayload(gasMonthly))
                    || (gasYearly != null && verifyDeveloperPayload(gasYearly)  || (gasQuaterly != null && verifyDeveloperPayload(gasQuaterly)));
            Log.d(TAG, "User " + (mSubscribedToInfiniteGas ? "HAS" : "DOES NOT HAVE")
                    + " infinite gas subscription.");
            String s= "User " + (mSubscribedToInfiniteGas ? "HAS" : "DOES NOT HAVE")
                    + " infinite gas subscription.";
    ...
    public void onInfiniteGasButtonClicked(View arg0) {
        ...
        if (!mSubscribedToInfiniteGas || !mAutoRenewEnabled) {
            ...
            options[2] = getString(R.string.subscription_period_quaterly);
            mFirstChoiceSku = SKU_INFINITE_GAS_MONTHLY;
            mSecondChoiceSku = SKU_INFINITE_GAS_YEARLY;
            mThirdChoiceSku=SKU_INFINITE_GAS_QUATER;
        } else {
            ...
            if (mInfiniteGasSku.equals(SKU_INFINITE_GAS_MONTHLY)) {
                ...
                mFirstChoiceSku = SKU_INFINITE_GAS_QUATER;
                options[1] = getString(R.string.subscription_period_yearly);
                mSecondChoiceSku = SKU_INFINITE_GAS_YEARLY;
            } else if (mInfiniteGasSku.equals(SKU_INFINITE_GAS_QUATER)) {
            ...
            else
            {
                ...
                options[0] = getString(R.string.subscription_period_quaterly);
                mFirstChoiceSku = SKU_INFINITE_GAS_QUATER;
                options[1] = getString(R.string.subscription_period_monthly);
                mSecondChoiceSku = SKU_INFINITE_GAS_MONTHLY;
    ...
    IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
        public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
           ...
           if (purchase.getSku().equals(SKU_INFINITE_GAS_MONTHLY)
                    || purchase.getSku().equals(SKU_INFINITE_GAS_YEARLY) ||  purchase.getSku().equals(SKU_INFINITE_GAS_QUATER)) {
                ...
                updateUi();
                setWaitScreen(false);
               SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(SubscriptionActivity.this);
    ...
    public void updateUi() {
       ...
       /* iv.setImageResource(mIsPremium ? R.drawable.premium : R.drawable.free);
        ...
        if (mSubscribedToInfiniteGas) {
            tvsubscriptiondesc.setText("Your are a premium member. You can manage your subcriptions.");
            // If subscription is active, show "Manage Infinite Gas"
            infiniteGasButton.setText("Manage Subscription");
        } else {
            // The user does not have infinite gas, show "Get Infinite Gas"
            tvsubscriptiondesc.setText("Your are not a premium member. You can subscribe now.");
            infiniteGasButton.setText("Subscribe Now");
        }
