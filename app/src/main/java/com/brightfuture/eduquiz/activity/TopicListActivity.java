...
import com.brightfuture.eduquiz.model.Topic;
...
public class TopicListActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Utils.transparentStatusAndNavigation(TopicListActivity.this);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            layout.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
        }
        toolbar = findViewById(R.id.toolBar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle(getString(R.string.select_test_to_play));
        ...
        boolean isPremium= Session.getBooleanData(ISPREMIUM,TopicListActivity.this);
        mAdView = findViewById(R.id.banner_AdView);
        if(isPremium)
        {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(TopicListActivity.this));
    ...
    private void getData() {
        ...
        if (Utils.isNetworkAvailable(TopicListActivity.this)) {
    ...
    public void getSubCategoryFromJson() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.QUIZ_URL,
                        ...
                        try {
                            ...
                            if (!error) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    tp.setId(object.getString(Constant.ID));
                                    tp.setDt_date(object.getString(Constant.dt_date));
                                    tp.setDt_name(object.getString(Constant.dt_name));
                                    tp.setDt_description(object.getString(Constant.dt_description));
                                ...
                                TopicAdapter1 adapter = new TopicAdapter1(TopicListActivity.this, topicList);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(Constant.GET_ALL_DISSCUSION_TOPICS, "1");
    ...
    public class TopicAdapter1 extends RecyclerView.Adapter<TopicAdapter1.ItemRowHolder> {
        private ImageLoader imageLoader = AppController.getInstance().getImageLoader();
        private ArrayList<Topic> dataList;
        private Context mContext;

        public TopicAdapter1(Context context, ArrayList<Topic> dataList) {
            this.dataList = dataList;
            this.mContext = context;
        }

        @Override
        public TopicAdapter1.ItemRowHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_category, parent, false);
            return new ItemRowHolder(v);
        }

        @Override
        public void onBindViewHolder(@NonNull TopicAdapter1.ItemRowHolder holder, final int position) {
            txtBlankList.setVisibility(View.GONE);
            final Topic tp = dataList.get(position);
            holder.text.setText((position+1)+":"+tp.getDt_name());
          ...
          /*  holder.image.setImageUrl(subCate.getImage(), imageLoader);*/
            holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(mContext, TopicAnswersActivity.class);
                    intent.putExtra(Constant.ID, tp.getId());
                    intent.putExtra(Constant.dt_name, tp.getDt_name());
                    intent.putExtra(Constant.dt_description, tp.getDt_description());
                    intent.putExtra(Constant.dt_date, tp.getDt_date());
                    startActivity(intent);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.setting:
                Utils.CheckVibrateOrSound(TopicListActivity.this);
                Intent playQuiz = new Intent(TopicListActivity.this, SettingActivity.class);
