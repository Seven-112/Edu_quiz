...
public class LearnMcqListActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Utils.transparentStatusAndNavigation(LearnMcqListActivity.this);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            layout.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
        }
        toolbar = findViewById(R.id.toolBar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle(getString(R.string.select_cat_to_learn));
        ...
        boolean isPremium= Session.getBooleanData(ISPREMIUM,LearnMcqListActivity.this);
        mAdView = findViewById(R.id.banner_AdView);
        if(isPremium)
        {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(LearnMcqListActivity.this));
    ...
    private void getData() {
        ...
        if (Utils.isNetworkAvailable(LearnMcqListActivity.this)) {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (!error) {
                                ...
                                SubCategoryAdapter1 adapter = new SubCategoryAdapter1(LearnMcqListActivity.this, subCateList);
        ...
        public void onBindViewHolder(@NonNull SubCategoryAdapter1.ItemRowHolder holder, final int position) {
            ...
            holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(mContext, LearnMcqActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.setting:
                Utils.CheckVibrateOrSound(LearnMcqListActivity.this);
                Intent playQuiz = new Intent(LearnMcqListActivity.this, SettingActivity.class);
