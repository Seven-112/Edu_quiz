...
public class TestCompletedActivity extends AppCompatActivity implements android.view.View.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Utils.transparentStatusAndNavigation(TestCompletedActivity.this);
        ...
        context = TestCompletedActivity.this;
        ...
        Utils.loadAd(TestCompletedActivity.this);
        ...
        coin = Session.getPoint(TestCompletedActivity.this);
        totalScore = Session.getScore(TestCompletedActivity.this);
        txt_score.setText("" + totalScore);
        lastLevelScore = Session.getLastLevelScore(TestCompletedActivity.this);
        ...
        if (TestMcqActivity.reviews.size() == 0) {
        ...
        isLevelCompleted = Session.isLevelCompleted(TestCompletedActivity.this);
//        levelNo = MainActivity.dbHelper.GetLevelById(Constant.CATE_ID, Constant.SUB_CAT_ID);


        if (isLevelCompleted) {
            txt_result_title.setText(getString(R.string.completed_test));
                getSupportActionBar().setTitle(getResources().getString(R.string.result));

        } else {
            txt_result_title.setText(getString(R.string.not_completed_test));
        ...
        if (Session.isLogin(TestCompletedActivity.this))
            getUserScore();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_playagain:
                TestMcqActivity.reviews.clear();

                Intent intent = new Intent(TestCompletedActivity.this, TestMcqActivity.class);
                intent.putExtra("fromQue", fromQue);
                startActivity(intent);
                ((TestCompletedActivity) context).finish();
            ...
            case R.id.btn_quite:
                //finish();
                Intent intent1 = new Intent(TestCompletedActivity.this, MainActivity.class);
            ...
            case R.id.btn_review:
                ...
                Intent intentReview = new Intent(TestCompletedActivity.this, ReviewTestActivity.class);
    ...
    public void shareClicked() {
        final String sharetext = "I have finished test on : " + TestMcqActivity.sub_cat_name + " with " + lastLevelScore + " Score in " + getString(R.string.app_name);
    ...
    public void getUserScore() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.QUIZ_URL,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(Constant.userId, Session.getUserData(Session.USER_ID, TestCompletedActivity.this));
    ...
    public void PdfClicked() {
        if (ContextCompat.checkSelfPermission(TestCompletedActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED &&
                ContextCompat.checkSelfPermission(TestCompletedActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(TestCompletedActivity.this, WRITE_EXTERNAL_STORAGE_PERMS, 0);
        } else {
            final AlertDialog.Builder dialog = new AlertDialog.Builder(TestCompletedActivity.this);
            LayoutInflater inflater1 = (LayoutInflater) (TestCompletedActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE));
            ...
            btnView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Uri uri = FileProvider.getUriForFile(TestCompletedActivity.this, getPackageName() + ".provider", file);
    ...
    public void GeneratePdf(String dest) {
        ...
        try {
            ...
            for (int i = 0; i < TestMcqActivity.reviews.size(); i++) {
                final Review review = TestMcqActivity.reviews.get(i);
            ...
            Toast.makeText(TestCompletedActivity.this, "No application found to open this file.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private class GeneratePdf extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            GeneratePdf(getAppPath(Objects.requireNonNull(TestCompletedActivity.this)) + "report.pdf");
            return "Executed";
        }
    ...
    public void onBackPressed() {
        finish();
        TestMcqActivity.reviews.clear();
        TestMcqActivity.questionListactual.clear();
        Intent intent = new Intent(TestCompletedActivity.this, TestMcqListActivity.class);
        intent.putExtra("fromQue", fromQue);
        startActivity(intent);
        finish();
