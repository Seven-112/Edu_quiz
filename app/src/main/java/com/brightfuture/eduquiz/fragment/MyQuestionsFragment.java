...
public class MyQuestionsFragment extends Fragment {
    ...
    public static MyQuestionsFragment newInstance(String position, Context activity) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.QUIZ_URL,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(Constant.accessKey, Constant.accessKeyValue);
                    ...
                    params.put(Constant.GET_COMMUNITY_QUESTIONS_BY_USER_ID, "1");
                    String uid=Session.getUserData(Session.USER_ID,context);
                    params.put(Constant.userId, uid);
